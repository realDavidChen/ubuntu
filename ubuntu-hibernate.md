...
### Now restart your computer. next time. then you log out your computer , you can see the "hibernate" optoin on the list. just click "hibernate" button. your computer will into hibernation status.
